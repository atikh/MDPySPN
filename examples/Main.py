import sys
sys.path.append('C:/Users/iu4647/Models/MDSPN/05- MDSPN')
...
pE1 = Place(label="PhEnegery1", is_dimension_holder=True, dimension_tracked='energy', initial_value=0)
pW1 = Place(label="PhWaste1", is_dimension_holder=True, dimension_tracked='waste', initial_value=0)
pE2 = Place(label="PhEnegery2", is_dimension_holder=True, dimension_tracked='energy', initial_value=0)
