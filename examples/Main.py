...
pE1 = Place(label="Tracking Place Energy1", is_tracking=True, dimension_tracked='energy', initial_value=0)
pW1 = Place(label="Tracking Place Waste1", is_tracking=True, dimension_tracked='waste', initial_value=0)
pE2 = Place(label="Tracking Place Energy2", is_tracking=True, dimension_tracked='energy', initial_value=0)
